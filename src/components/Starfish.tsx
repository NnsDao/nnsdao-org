  ...
  return (
    <div id="home" className="h-min-screen">
      ...
      <div className="flex relative text-white justify-center">
        ...
        <a href="https://github.com/NnsDao/nnsdao-org/blob/main/static/NnsDAO_Boundaryless_Autonomous_Organization.pdf" className="cursor-pointer">
          <img className="flex  absolute top-96 left-16 md:top-120 md:left-60" width="204px" height="56px" src="/imgs/bg-whitepaper-hover.png" alt="nnsdao whitepaper" />
        </a>
      </div>
    </div>
  );
